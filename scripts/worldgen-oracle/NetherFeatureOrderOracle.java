// Independent Nether decoration-order oracle. It asks the bundled server's
// feature sorter for the five built-in Nether biomes' flattened feature order
// and emits the raw per-step indices used to seed each feature.
...
public final class NetherFeatureOrderOracle {
    public static void main(String[] args) {
        ...
        HolderLookup.RegistryLookup<PlacedFeature> registry =
