...
decide. Direct proposal consumers have no durable history or read-only monitor tier; the
proposal-backed Paper event bus adds ordered listener priorities separately.
