...
`LODESTONE_ORACLE_END_BOUNDED=1` selects two-row End v5 shards, each no larger than 1002 centres and run in a fresh JVM. It is opt-in so existing 16-wide worker geometry remains unchanged.
