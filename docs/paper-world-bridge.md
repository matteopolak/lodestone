...
For batch operations, retain the 4,096-position cap, input ordering, and exact response-length check. Do not turn a missing column into a load/generate request, and do not add a world or ECS handle to `WorldPort`.
