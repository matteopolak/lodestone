...
#[cfg(test)]
#[path = "tests/wandering_trader.rs"]
...
#[cfg(test)]
#[path = "tests/villager_gossip_reputation_and_curing.rs"]
...
#[path = "tests/villager_bed_claim.rs"]
...
#[cfg(test)]
#[path = "tests/villager_schedule.rs"]
...
#[cfg(test)]
#[path = "tests/vibration_substrate.rs"]
...
#[cfg(test)]
#[path = "tests/elder_guardian_mining_fatigue.rs"]
