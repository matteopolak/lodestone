...
//!
//! Any packet embedding `Slot` (`WindowItems`, `SetSlot`, `WindowClick`,
//! `SetCreativeSlot`, `OpenWindow`) inherits this same 47..=340 restriction,
//! even where the *embedding* struct's own field list is textually identical
//! across all three families -- the struct scan cannot see through a field's
//! type to a divergent type definition behind it.
//!
