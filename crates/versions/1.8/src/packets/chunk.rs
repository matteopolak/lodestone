...
/// modern [`ChunkShape`](../../../lodestone_v26_2/packets/chunk/struct.ChunkShape.html)
...
fn decode_column(
    ...
    //
    //    Unlike v1-9 there is no palette on the wire to translate once, so
...
/// majority of columns, which need no fallback at all. Mirrors v1-9's
