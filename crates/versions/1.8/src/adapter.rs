...
///
/// Mirrors `lodestone-v1-9`'s identically-named helper, added there after
...
/// Resolves a validated legacy effect id to its canonical resource key.
fn legacy_effect_key(effect_id: MobEffectId) -> Result<ResourceKey, AdapterError> {
...
/// the same formula and is used identically by v1-9 and v1-14.
...
impl V47Adapter {
    ...
    fn handle_play_entity_status(
        ...
        payload: &[u8],
            ...
            // (identical shape at 1.12.2) and matching `lodestone-v26-2`'s own
    ...
    fn handle_play_block_change(
        ...
        payload: &[u8],
            ...
            // same shared table `lodestone-v1-9` uses, not this crate's own
    ...
    fn handle_play_multi_block_change(
        ...
        payload: &[u8],
            ...
            // (identical shape at 1.12.2, where `lodestone-v1-9`'s own arm
    ...
    fn handle_play_attach_entity(
        ...
        payload: &[u8],
            ...
            // `AttachEntity`'s own doc); this is not `lodestone-v1-9`'s
    ...
    fn handle_play_entity_effect(
        ...
        payload: &[u8],
            ...
            return Ok(vec![Directive::Emit(ClientEvent::MobEffectApplied {
                entity_id: body.entity_id,
                effect: legacy_effect_key(effect_id)?,
    ...
    fn handle_play_spawn_entity_painting(
        ...
        payload: &[u8],
            ...
            return Ok(vec![Directive::Emit(ClientEvent::EntitySpawned {
                ...
                // `lodestone-v1-9`'s treatment of the same gap.
                rotation: Rotation::new(0.0, 0.0),
                velocity: None,
            })]);
            }
    ...
    fn handle_play_scoreboard_team(
        ...
        payload: &[u8],
            ...
            // collision-rule field** (a 1.9 addition `lodestone-v1-9`'s
    ...
    fn play_dispatch_table() -> lodestone_core::dispatch::Table<'static, PlayHandlerFn> {
        ...
        .expect("v1-8 play::clientbound dispatch table must be internally consistent")
    }
...
impl VersionAdapter for V47Adapter {
    ...
    fn encode_action(
        ...
        match action {
            ...
            // it is rejected loudly (same posture as v26-2).
