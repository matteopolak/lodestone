...
can refresh, and "regenerate it" stops being an instruction.
    ...
    python3 crates/versions/1.8/oracle/extract_real_section.py \
        .cache/mc/1.8.9/world/region \
        crates/versions/1.8/tests/support/real_1_8_9_section_save.txt
...
def write_fixture(region_dir, out_path):
    ...
    for _, chunk_x, chunk_z, section_y, cells in sections(region_dir):
        ...
        header = [
            ...
            "#",
            "# Regenerate with crates/versions/1.8/oracle/extract_real_section.py",
            "#",
