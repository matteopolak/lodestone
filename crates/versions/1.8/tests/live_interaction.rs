...
//!
//! ```text
//! cargo test -p lodestone-v1-8 --features live-interaction -- --ignored live_interaction
//! ```
//!
...
use lodestone_v1_8::packets::game::ClientboundPositionLook;
use lodestone_v1_8::packets::position::unpack_position;
...
/// [`lodestone_v1_8::packets::game::BlockPlace`]); the server resolves the actual
