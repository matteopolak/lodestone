...
// from tests/support/blocks_1_13_2_jar.json (protocol 404 / Minecraft 1.13.2) against
...
//! `lodestone_data::block_states` id that 1.13.2 wire state carries. Pure
//! rodata, zero heap; see `src/canonical.rs` for the lookup wrapper.

/// Number of block states in 1.13.2's own global palette (source ids are
/// `0..SOURCE_STATE_COUNT`).
pub const SOURCE_STATE_COUNT: u32 = 8599;
...
/// `STATE_TO_CANONICAL[s]` is the canonical 26.2 state id for 1.13.2 flat
/// wire state `s`.
