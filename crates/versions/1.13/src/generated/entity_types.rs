...
// from vendor/minecraft-data/data/pc/1.13.2/entities.json (protocol 404 /
// Minecraft 1.13.2). DO NOT EDIT BY HAND. Regenerate with LODESTONE_REGEN=1
// (see the test module docs).
//! Generated entity-type id->name table for protocol 404 (Minecraft 1.13.2).
//!
...
pub const ENTITY_TYPE_COUNT: usize = 95;

/// `(type id, canonical identifier)` pairs, sorted by id for binary search.
pub static ENTITY_TYPES: [(i32, &str); 95] = [
    ...
    (41, "minecraft:command_block_minecart"),
