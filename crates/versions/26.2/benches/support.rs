//! Shared bench-recording helper for `lodestone-v26-2`'s criterion benches.
...
//! ~100 lines twice (worldgen + v26-2, byte-for-byte identical) is cheaper than
//! the coordination cost of a third crate mid-epic. If a third bench site
//! needs this, promoting it to a real crate is the right move then — see the
//! harness patch note in the epic report for what that would need from the
//! workspace root.
//!
//! # What this does
//!
