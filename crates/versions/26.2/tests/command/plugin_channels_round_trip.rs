...
//! seam method, its `v26-2` implementation, and a broadcast drain in
...
/// the raw bytes intact — through the real client encoder, the real `v26-2`
...
/// hand-written `v26-2` encoder, and a real in-memory `Connection`, and comes
