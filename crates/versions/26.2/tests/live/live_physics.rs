...
//! isolation rule these tests live here to honour — they belong in v26-2
//! *because* they name v26-2's concrete packet types, and a client-seam test
...
//!
//! ```text
//! cargo test -p lodestone-v26-2 --features live-physics --test live_physics -- --ignored --nocapture
//! ```
//!
