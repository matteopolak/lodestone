...
//! cargo test -p lodestone-v26-2 --features live-registry --test live_registry_data \
//!     -- --ignored --nocapture
//! ```
//!
...
use lodestone_v26_2::packets::registry::{ClientRegistries, DimensionType, RegistryData};
...
fn mojang_biome_climate(short_name: &str) -> Option<lodestone_v26_2::packets::registry::BiomeClimate> {
    ...
    Some(lodestone_v26_2::packets::registry::BiomeClimate {
