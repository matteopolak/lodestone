...
//! `ServerProtocol::encode_resource_pack_push` seam method, its `v26-2`
...
//! decoding the real `v26-2` bytes into `ClientEvent::ResourcePackPushed`.
//!
...
/// `serve_play`'s timer drain, the hand-written `v26-2` encoder, and a real
