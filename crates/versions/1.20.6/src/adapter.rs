...
impl V766Adapter {
    ...
    /// `minecraft:death_combat_event`. The split death packet carries the
    /// local player's id, the killer entity id, and a JSON death-message
    /// component. The ids are routing metadata; the message is the part the
    /// client model and shell consume.
