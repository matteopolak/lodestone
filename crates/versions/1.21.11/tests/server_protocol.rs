...
fn container_session_hosting_uses_literal_774_layouts() {
    // These vectors are independently assembled from the committed
    // `vendor/minecraft-data/data/pc/1.21.11/protocol.json` packet shapes,
    // not generated by either this server encoder or the client adapter.
