...
fn production_death_and_respawn_encoders_match_wire_controls() {
    ...
    assert_eq!(
        position,
        &hex("2a 3f f8 00 00 00 00 00 00 40 50 00 00 00 00 00 00 c0 02 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00")
    );
}
