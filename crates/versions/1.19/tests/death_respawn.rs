//! Independent protocol-762 death notification fixtures.
//!
//! The split death packet body is written directly from its wire shape:
//! player id, killer entity id, then a JSON death-message string.

use lodestone_model::{route, ClientEvent, ConnectionState, Directive, VersionAdapter};
use lodestone_v1_19::{adapter_for, packet_ids, PROTOCOL_1_19_4};
...
fn death_combat_event_emits_the_model_death_event() {
    ...
    let directives = adapter_for(PROTOCOL_1_19_4)
        ...
        .expect("literal protocol-762 death fixture decodes");
