// @generated by a one-off script reading vendor/minecraft-data/data/pc/1.7/items.json
// (protocol 5 / Minecraft 1.7.10). DO NOT EDIT.
//!
//! Generated legacy item id->name table for protocol 5.
//!
//! One row per numeric item id this era's `Slot` wire type can carry. The
//! names are already `snake_case` in the source data and every one of them
//! matches `^[a-z0-9_]+$`, so no case-folding judgement was made here.

/// Number of item ids in the table.
pub const ITEM_TYPE_COUNT: usize = 303;

/// `(numeric id, name)` pairs, sorted by id for binary search.
pub static ITEM_TYPES: [(i32, &str); 303] = [
    (1, "stone"),
    (2, "grass"),
    (3, "dirt"),
    (4, "cobblestone"),
