...
//!
//! Like the v1-8 equivalent these are *seam* tests through the real
...
//! by 128× and cannot pass. Written independently of v1-8 — the two families are
...
use lodestone_v1_9::packets::entity::{
