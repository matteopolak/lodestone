...
//! `lodestone-v26-2`'s own `tests/block_updates.rs` uses for the modern
...
//!
//! The expected canonical block-state ids come from `lodestone_v1_9::canonical
...
use lodestone_v1_9::packets::position::pack_position;
use lodestone_world::{
