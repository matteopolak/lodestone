...
//!
//! ```text
//! cargo test -p lodestone-v1-9 --features live-entity -- --ignored live_entity
//! ```
//!
...
use lodestone_v1_9::packets::entity::{EntityMetadataPacket, SpawnEntityLiving};
use lodestone_v1_9::packets::game::ClientboundPositionLook;
use lodestone_v1_9::packets::metadata::MetadataValue;
use lodestone_v1_9::packets::window::HeldItemSlot;
...
///
/// Same discipline as the v1-8 gate: the test above decodes
