...
/// Number of legacy sound entries (network ids are `0..SOUND_ID_COUNT`).
pub const SOUND_ID_COUNT: usize = 549;

/// Legacy sound name, without a namespace prefix, indexed by network id.
