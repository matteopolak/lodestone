...
// from tests/support/blocks_1_15_2_jar.json (protocol 578 / Minecraft 1.15.2) against
...
//! `lodestone_data::block_states` id that 1.15.2 wire state carries. Pure
//! rodata, zero heap; see `src/canonical.rs` for the lookup wrapper.

/// Number of block states in 1.15.2's own global palette (source ids are
/// `0..SOURCE_STATE_COUNT`).
pub const SOURCE_STATE_COUNT: u32 = 11337;
...
/// `STATE_TO_CANONICAL[s]` is the canonical 26.2 state id for 1.15.2 flat
/// wire state `s`.
