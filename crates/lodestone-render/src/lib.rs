...
pub use block_entity::{
    ...
    CONDUIT_WIND_VERTICAL_TEXTURE_STEM, CampfireItemSpawn, ChestHalf, ChestMaterial, ChestSpawn,
    ...
    LECTERN_BOOK_PAGE_FLIP, LecternSpawn, MovingPistonSpawn, VaultSpawn, SHIELD, SHIELD_BASE_TEXTURE_STEM,
