...
//!   a reflective dump of the private lookup table inside the real 1.13.2
//!   server jar's own world-upgrade (old-save conversion) step. Provenance is
//!   the jar, not this repo; see
...
//! 1.13.2 world-upgrade step's own — it upgrades *1.12.2-space* ids, and older versions'
...
/// from the real 1.13.2 server jar's own world-upgrade flattening step
