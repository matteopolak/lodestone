...
//!    [`lodestone_v770::block_solidity`] — state-keyed, so it lives behind the
...
//!
//! ```text
//! LODESTONE_REGEN=1 cargo test -p lodestone-v770 --test block_physics \
...
use lodestone_v770::{block_solidity, block_states, collision_shapes};
