...
//!
//! ```text
//! LODESTONE_REGEN=1 cargo test -p lodestone-v770 --test block_states \
...
use lodestone_v770::block_states::{self, BlockStateTable};
...
fn generate(doc: &serde_json::Value) -> String {
    ...
    out.push_str(
        "// @generated by `cargo test -p lodestone-v770 --test block_states -- --ignored`\n\
