...
//!
//! ```text
//! LODESTONE_REGEN=1 cargo test -p lodestone-v770 --test path_types \
...
use lodestone_v770::path_types::{self, PathTypes};
...
fn generate(text: &str) -> String {
    ...
    out.push_str(
        "// @generated by `cargo test -p lodestone-v770 --test path_types -- --ignored`\n\
