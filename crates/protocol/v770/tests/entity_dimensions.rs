...
//!
//! ```text
//! LODESTONE_REGEN=1 cargo test -p lodestone-v770 --test entity_dimensions \
...
use lodestone_v770::entity_dimensions::{base_dimensions, TYPE_COUNT};
...
fn generate(rows: &[Row]) -> String {
    ...
    out.push_str(
        "// @generated by `cargo test -p lodestone-v770 --test entity_dimensions -- --ignored`\n\
