// @generated by `cargo test -p lodestone-v47 --test item_types -- --ignored`
// from vendor/minecraft-data/data/pc/1.8/items.json (protocol 47 /
// Minecraft 1.8.x). DO NOT EDIT BY HAND. Regenerate with LODESTONE_REGEN=1
// (see the test module docs).
//! Generated item-id->name table for protocol 47 (Minecraft 1.8.x).
//!
//! Maps 1.8's `Slot` numeric item id to its canonical family identifier
...
pub const ITEM_TYPE_COUNT: usize = 336;

/// `(item id, canonical identifier)` pairs, sorted by id for binary search.
pub static ITEM_TYPES: [(i32, &str); 336] = [
    (1, "minecraft:stone"),
    (2, "minecraft:grass"),
    (3, "minecraft:dirt"),
