...
//!
//! ```text
//! cargo test -p lodestone-v47 --features live-entity -- --ignored live_entity
//! ```
//!
...
use lodestone_v47::packets::entity::{EntityMetadataPacket, SpawnEntityLiving};
use lodestone_v47::packets::metadata::MetadataValue;
use lodestone_v47::packets::window::HeldItemSlot;
