...
use lodestone_v47::packets::world::{
...
fn spawn_position_reports_the_current_dimension() {
    ...
    let login = lodestone_v47::packets::game::JoinGame {
        entity_id: 1,
        game_mode: 0,
        dimension: -1,
        difficulty: 0,
    ...
    let payload = encode(&SpawnPosition {
        location: lodestone_v47::packets::position::Position(lodestone_model::BlockPos::new(
            11, 4, 100,
        )),
    });
