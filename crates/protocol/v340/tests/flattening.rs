...
//!     crates/protocol/v340/oracle-java/FlatteningOracle.java
...
//!
//! ```text
//! LODESTONE_REGEN=1 cargo test -p lodestone-v340 --test flattening \
...
use lodestone_v340::flattening::{self, LegacyBlockState};
