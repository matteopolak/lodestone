...
use lodestone_v340::packets::player_info::{PlayerInfoAction, PlayerInfoEntry};
use lodestone_v340::packets::slot::Slot;
use lodestone_v340::packets::window::{CloseWindow, OpenWindow, SetSlot, WindowItems};
...
fn player_info_add_player_carries_gamemode_ping_name_and_skin_properties() {
    ...
    let entries = vec![PlayerInfoEntry {
        ...
        action: PlayerInfoAction::AddPlayer {
            name: "Notch".into(),
            properties: vec![lodestone_v340::packets::player_info::PlayerInfoProperty {
                name: "textures".into(),
