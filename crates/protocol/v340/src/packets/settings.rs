...
//! to v735's own definitions (measured/verified), so they now live in
//! `lodestone-protocol-common`. `PlayerAbilities` is shared with v47 only
//! (`#[mc(protocols = "47..=340")]` -- 1.16/v735 dropped the two speed
