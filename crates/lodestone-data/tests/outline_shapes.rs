...
fn generate(dump: &Dump) -> String {
    ...
    out.push_str(
        "// @generated by `cargo test -p lodestone-data --test outline_shapes -- --ignored`\n\
         ...
         // each block state's own outline-shape and interaction-shape accessors,\n\
...
/// Vanilla's own light-block outline-shape accessor returns a full cube only
/// while the querying context is holding a light item, and an empty shape
/// otherwise, and the census dumps every shape with
