...
//!
//! ```text
//! LODESTONE_REGEN=1 cargo test -p lodestone-v770 --test collision_shapes \
...
use lodestone_v770::collision_shapes;
...
fn generate(text: &str) -> String {
    ...
    out.push_str(
        "// @generated by `cargo test -p lodestone-v770 --test collision_shapes -- --ignored`\n\
