...
// Source: .cache/mc/26.2/generated/reports/registries.json registry minecraft:item.
//! Generated item id->ResourceKey table for protocol 776 (Minecraft 26.2).
//!
//! item stacks carry an item registry id (Holder<Item> via id-mapper) before the data-component patch.

/// Number of item entries (network ids are `0..ITEM_COUNT`).
pub const ITEM_COUNT: u32 = 1537;

/// Canonical item identifier, indexed by network registry id.
pub static ITEM_NAMES: [&str; 1537] = [
    "minecraft:air",
    "minecraft:stone",
    "minecraft:granite",
