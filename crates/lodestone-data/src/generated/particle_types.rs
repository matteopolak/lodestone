...
// Source: .cache/mc/26.2/generated/reports/registries.json registry minecraft:particle_type.
//! Generated particle type id->ResourceKey table for protocol 776 (Minecraft 26.2).
//!
//! level_particles carries a particle-type registry id before any per-particle payload data.

/// Number of particle type entries (network ids are `0..PARTICLE_TYPE_COUNT`).
pub const PARTICLE_TYPE_COUNT: u32 = 125;

/// Canonical particle type identifier, indexed by network registry id.
pub static PARTICLE_TYPE_NAMES: [&str; 125] = [
