...
//! v770 specifically, the one family that also hosts (`ServerProtocol`), and
//! v770 is by far the most actively developed of the four (see `CLAUDE.md`'s
//! "new gameplay work targets v770" default).
